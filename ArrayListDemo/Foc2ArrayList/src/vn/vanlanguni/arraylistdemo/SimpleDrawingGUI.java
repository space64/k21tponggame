...
public class SimpleDrawingGUI extends JFrame implements ActionListener {
	SimpleDrawingPanel pnlMain;
	JPanel pnlTop;
	...
	public SimpleDrawingGUI() {
		setTitle("Simple Drawing - Space64");
		pnlTop = new JPanel();
		...
		btnAdd.setBounds(283, 11, 78, 44);
		pnlTop.add(btnAdd);

		// Button Clear
		btnClear = new JButton("Clear");
		btnClear.addActionListener(this);
		btnClear.setBounds(371, 11, 78, 44);
		pnlTop.add(btnClear);
		...
		// Main panel
		pnlMain = new SimpleDrawingPanel();
	...
	private void selectColor() {
		drawColor = JColorChooser.showDialog(SimpleDrawingGUI.this, "Select a draw color", drawColor);
		btnColor.setBackground(drawColor);
	}
	...
	public static void main(String[] args) {
		SimpleDrawingGUI f = new SimpleDrawingGUI();
